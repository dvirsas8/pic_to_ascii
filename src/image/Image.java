...
public interface Image {
    ...
    /**
     * Allows creating and iterating over subimages of a selected resolution
     * @param resolution the selected resolution of the wanted subimages
     * @return an iterable<SubImage> that can be traversed with a foreach loop
     */
    default Iterable<Image> subImages(int resolution) {
        return new ImageIterableProperty<>(
                this, (x,y)-> new SubImage(this, x, y, resolution), resolution);
    }
}
